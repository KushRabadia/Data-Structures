...
class Stack:
    ...
    def push(self, value):
        ...
        self._top = _Stack_Node(deepcopy(value),self._top)
        return 
    ...
    def reverse(self):
        ...
        while self._top != None:
            temp.append(self._top._value)
            self._top = self._top._next
        
        for i in temp:
            self._top = _Stack_Node(deepcopy(i),self._top)
    ...
    def combine(self, source1, source2):
        ...
        -------------------------------------------------------
        """
        while source1._top != None and source2._top != None:
            self._move_top(source1)
            self._move_top(source2)
        
        while source1._top != None :
            self._move_top(source1)
        while source2._top != None :
            self._move_top(source2)
